  ...
  const handleClick = (organization: any) => {
    ...
    if (organizationDetails) {
      ...
      setFormData({
        ...
        hippaPrivacyOfficer: organizationDetails.hippaprivacyofficer?.[0]?.name || "",
        id: organization.id || "",
      });
      console.log("Hippa Privacy Officer Name:", organizationDetails.hippaprivacyofficer?.[0]?.name);
